...
export class HsvSlider extends TBMCPCanvas {
	component: string;

	constructor( component: string, matColorPickerService: MatColorPickerService ) {
		super( component, matColorPickerService );
		if ( component === 'h' ) {
			return matColorPickerService.getCanvas('hue', this.component) as HsvSlider;
		}
	}
