/*
 * Public API Surface of mat-color-picker
 */

export * from './lib/mat-color-picker.service';
export * from './lib/mat-color-picker.component';
export * from './lib/mat-color-picker.module';
